function data_fitting_large_library_770000_IE_fitting
clear all

[M0_codeA] = data_770000_library_M0_codeA;
[M0_codeB] = data_770000_library_M0_codeB;
[M0_count] = data_770000_library_M0_count;

[M1_codeA] = data_770000_library_M1_codeA;
[M1_codeB] = data_770000_library_M1_codeB;
[M1_count] = data_770000_library_M1_count;

[M2_codeA] = data_770000_library_M2_codeA;
[M2_codeB] = data_770000_library_M2_codeB;
[M2_count] = data_770000_library_M2_count;

[M3_codeA] = data_770000_library_M3_codeA;
[M3_codeB] = data_770000_library_M3_codeB;
[M3_count] = data_770000_library_M3_count;
...
legend('Data', 'Model')
set(gca,'FontSize',20)
file_out2 = './library_with_770000_IE .png';
...
% fclose(fid);
% 
% fid=fopen('Model_770000_library_raw_data_M1_model.txt','w');
% fprintf(fid, '%.15f\n',new_data);
% fclose(fid);
