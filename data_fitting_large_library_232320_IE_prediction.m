function data_fitting_large_library_232320_IE_prediction
clear all

[P0_codeA, P0_codeB, P0_count, P1_codeA, P1_codeB, P1_count, P2_codeA, P2_codeB, P2_count,P3_codeA, P3_codeB, P3_count] = data_232320_library;
...
legend('Data', 'Model')
set(gca,'FontSize',20)
file_out2 = './library_232320_IE.png';
saveas(gcf,file_out2)


% 
% % write to a new file
% fid=fopen('Data_232320_library_raw_data_M1_true_data.txt','w');
% fprintf(fid,'%.15f\n', data1);
% fclose(fid);
% 
% fid=fopen('Model_232320_library_raw_data_M1_model.txt','w');
% fprintf(fid, '%.15f\n',new_data);
% fclose(fid);
